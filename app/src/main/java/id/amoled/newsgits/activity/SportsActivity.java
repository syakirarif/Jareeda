...
public class SportsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listBusiness = findViewById(R.id.list_sport);
        listBusiness.setHasFixedSize(true);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(this);
        listBusiness.setLayoutManager(layoutManager);

        swipeLayout = findViewById(R.id.layout_swipe_sport);
    ...
    private void loadArticleSource(boolean isRefreshed) {
        ...
        if (!isRefreshed) {
            ...
            String cache = Paper.book().read("sport"); //GANTI INI
            ...
            if (cache != null && !cache.isEmpty() && !cache.equals("null")) {
                ...
                mService.getSport().enqueue(new Callback<WebSite>() { //GANTI INI
                    @Override
                    public void onResponse(@NonNull Call<WebSite> call, @NonNull Response<WebSite> response) {
                        ...
                        Paper.book().write("sport", new Gson().toJson(response.body())); //GANTI INI
                        swipeLayout.setRefreshing(false);
                    }
